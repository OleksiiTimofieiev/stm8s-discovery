 ...
 * LSM6.h
 *
 *  Created on: 30 ìàðòà 2017
 *      Author: SnowBars
 */

#ifndef LSM6_INC_LSM6_H_
#define LSM6_INC_LSM6_H_

   /*
#include "em_device.h"
   */

#define NEAD_FOR_READ_LSM 0xff

#define CARDIO_STATE_UP_LIM   -6000   //x<-15
#define CARDIO_STATE_DOWN_LIM 6000   //x>15
...
#define LED_ADC_PIN LSM6_PWDN_PIN
...
typedef struct{
  LSM6_pin_en LSM6_pin_name;
  uint32_t LSM6_GPIO_Pin;
  uint32_t LSM6_GPIO_Port;
}LSM6_pin_t;


//#define LSM6DS3_ADD_1					0x6B
//#define LSM6DS3_ADD_2					0x6A

#define LSM6DS3_ADD_1					0xD4
#define LSM6DS3_ADD_2					0xD7

#define LSM6DS3_DEVICE_ID			0x69

#define LSM6DS3_FUNC_CFG_ACCESS		0x01
#define LSM6DS3_FUNC_CFG_ACCESS_BIT_EN	0x80
#define LSM6DS3_FUNC_CFG_ACCESS_BIT_DS	0x00
...
#define LSM6DS3_CONFIG_PEDO_DEB_MIN          0x14
...
* Register      : PEDO_THS
* Address       : 0X0F
* Bit Group Name: THS_VALUE
* Permission    : RW
*******************************************************************************/

#define LSM6DS3_CONFIG_PEDO_THS_VALUE 0x96

/*******************************************************************************
* Register      : PEDO_DEB_VALUE
* Address       : 0X14
* Bit Group Name: DEB_VALUE
* Permission    : RW
*******************************************************************************/

#define LSM6DS3_CONFIG_PEDO_DEB_VALUE 0x0E

/*******************************************************************************
* Register      : SM_THS_VALUE
* Address       : 0X13
* Bit Group Name: DEB_VALUE
* Permission    : RW
*******************************************************************************/

#define LSM6DS3_SM_STEP_THS_VALUE	0x8A
/*============================================================================
Enums
============================================================================*/
...
typedef enum {
	...
	LSM6DS3_FS_XL_16g 		 = 0x01,
	LSM6DS3_FS_XL_4g 		 = 0x02,
	LSM6DS3_FS_XL_8g 		 = 0x03,
} LSM6DS3_FS_XL_t;
...
typedef enum {
	...
	LSM6DS3_FS_G_500dps 		 = 0x01,
	LSM6DS3_FS_G_1000dps 		 = 0x02,
	LSM6DS3_FS_G_2000dps 		 = 0x03,
} LSM6DS3_FS_G_t;
...
*******************************************************************************/
typedef enum {
	LSM6DS3_INT_FLAG_FF_IA                         = 0x20,
	LSM6DS3_INT_FLAG_SLEEP_STATE_IA                = 0x10,
        LSM6DS3_INT_FLAG_WU_IA                         = 0x08,
        LSM6DS3_INT_FLAG_X_WU                          = 0x04,
        LSM6DS3_INT_FLAG_Y_WU                          = 0x02,
        LSM6DS3_INT_FLAG_Z_WU                          = 0x01
} LSM6DS3_INT_WAKE_UP_SRC_t;

typedef enum {
        LSM6DS3_INT_FLAG_TAP_IA                        = 0x40,
        LSM6DS3_INT_FLAG_SINGLE_TAP                    = 0x20,
        LSM6DS3_INT_FLAG_DOUBLE_TAP                    = 0x10,
        LSM6DS3_INT_FLAG_TAP_SIGN                      = 0x08,
        LSM6DS3_INT_FLAG_X_TAP                         = 0x04,
        LSM6DS3_INT_FLAG_Y_TAP                         = 0x02,
        LSM6DS3_INT_FLAG_Z_TAP                         = 0x01,
} LSM6DS3_INT_TAP_SRC_t;

typedef enum {
        LSM6DS3_INT_FLAG_D6D_IA                        = 0x40,
        LSM6DS3_INT_FLAG_ZH                            = 0x20,
        LSM6DS3_INT_FLAG_ZL                            = 0x10,
        LSM6DS3_INT_FLAG_YH                            = 0x08,
        LSM6DS3_INT_FLAG_YL                            = 0x04,
        LSM6DS3_INT_FLAG_XH                            = 0x02,
        LSM6DS3_INT_FLAG_XL                            = 0x01,
} LSM6DS3_INT_D6D_SRC_t;

typedef enum {
        LSM6DS3_INT_FUNC_STEP_COUNT_DELTA_IA           = 0x80,
        LSM6DS3_INT_FUNC_SIGN_MOTION_IA                = 0x40,
        LSM6DS3_INT_FUNC_TILT_IA                       = 0x20,
        LSM6DS3_INT_FUNC_STEP_DETECTED                 = 0x10,
        LSM6DS3_INT_FUNC_STEP_OVERFLOW                 = 0x08,
        LSM6DS3_INT_FUNC_SI_END_OP                     = 0x02,
        LSM6DS3_INT_FUNC_SENSORHUB_END_OP              = 0x01,
...
#define _180_DIV_PI 57.29

#define L_STAY_LIM  4547034
#define H_STAY_LIM 	151169041

#define FALL_LIM_L 10749798
#define FALL_LIM_H 419914001

#define LIM_GYRO 250
#define PER_POSTURE 500
...
typedef struct
{
	...
	uint8_t pedRdy;
	uint8_t postureCnt;
	uint8_t postureArr[10];
}sBodyState_t;
/^
extern sBodyState_t BodyState;
extern sAngleAc_t g_AngleAc;
extern sAngleGyro_t AngleGyro;
*/
typedef struct
{
    float ax;
...
extern MotionData motionDataF;
extern ImuRawData RawData;
uint16_t LSM6_GetPin(LSM6_pin_en _LSM6_pin_name);
void LSM6__SetPin(LSM6_pin_en ADS1292_pin_name, eLSM6_Bit_State_t BitVal);
status_t initLSMReg();
